...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\Bo\\AdminBundle\\Entity')), 'Bo\\AdminBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BoAdminBundle' => 'Bo\\AdminBundle\\Entity'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('ip-admin@numericable.fr');
        $a->setPassword('Pa$$w0rd');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\Bo\\AdminBundle/Resources/views', 'BoAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('297a25128bfe9bfdc11448eee8a5a77ee62ae9ea');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'ip-admin@numericable.fr',
            'mailer_password' => 'Pa$$w0rd',
            'locale' => 'en',
            'secret' => '297a25128bfe9bfdc11448eee8a5a77ee62ae9ea',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => '297a25128bfe9bfdc11448eee8a5a77ee62ae9ea',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'ip-admin@numericable.fr',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Pa$$w0rd',
