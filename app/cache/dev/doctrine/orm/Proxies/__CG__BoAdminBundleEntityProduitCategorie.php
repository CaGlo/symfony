 ...
 */
class ProduitCategorie extends \Bo\AdminBundle\Entity\ProduitCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Bo\\AdminBundle\\Entity\\ProduitCategorie' . "\0" . 'id', '' . "\0" . 'Bo\\AdminBundle\\Entity\\ProduitCategorie' . "\0" . 'nom', '' . "\0" . 'Bo\\AdminBundle\\Entity\\ProduitCategorie' . "\0" . 'description', 'produits');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProduitCategorie $proxy) {
